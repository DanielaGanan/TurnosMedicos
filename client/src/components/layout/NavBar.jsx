  ...
  return (
    <nav className="navbar navbar-expand-lg navbar-custom">
      <div className="container">
        <Link className="navbar-brand text-light fw-bold" to="/">Turnos Medicos</Link>
          ...
          <ul className="navbar-nav ms-auto">
            ...
            {!isAuthenticated ? (
              ...
              <>
                ...
                <li className="nav-item"><button className="btn btn-link nav-link" onClick={handleLogout}>Cerrar sesion</button></li>
              </>
            )}
          </ul>
        </div>
